...
ForkFlow is a decentralized reality simulation sandbox with branching capabilities, combining the depth of Dwarf Fortress with the programmability of Screeps. The game world evolves on Git-like principles, where every change i
s a commit, and players can create and merge alternative history branches in a fully P2P network.
...
The project is at a very early stage of active development. Current work focuses on core architecture, delta systems, and virtual machine implementation. The current version uses a client-server model as a stepping stone towar
d a full P2P architecture.
